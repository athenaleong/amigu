...
import Question from '@/Assets/question-mark-orange.png'
...
import WoodBackground from '@/Assets/background/wood-background.jpeg';
const FidgetContainer = (props) => {
    ...
    return (
        ...
        >
            <Box height='100%' width={'60%'}>
                <ImageBackground source={WoodBackground} resizeMode='cover' style={styles.image}>
                    <Flex direction='column' align='center'>
                            <Text color='white' variant='subtitleL'>Fidget Bench</Text>
            ...
            <Flex  height='100%' width={'40%'} bg='amber.500'>
                            ...
                            data.map((item, idx) => {
                                return (
                                    <Pressable key={idx} onPress={() => treasureOnPress(idx)}>
                                        <TreasureBubble data={item} display={collected[idx]} bg='amber.300' question={Question}/>
                                    </Pressable>
                                )
                            })
...
export default FidgetContainer;